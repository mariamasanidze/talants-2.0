  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Cosmic variants
        cosmic: "bg-gradient-nebula text-white font-semibold relative overflow-hidden shadow-glow hover:shadow-glow-lg hover:-translate-y-1 before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/20 before:to-transparent before:-translate-x-full hover:before:translate-x-full before:transition-transform before:duration-500",
        
        hero: "bg-primary text-primary-foreground font-bold text-base px-8 py-4 rounded-lg shadow-glow hover:shadow-glow-lg hover:-translate-y-1 hover:scale-105 transition-all duration-300",
        
        "cosmic-outline": "border-2 border-primary bg-transparent text-primary hover:bg-primary hover:text-primary-foreground shadow-glow hover:shadow-glow-lg transition-all duration-300",
