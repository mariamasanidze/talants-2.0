...
//       description: "Remote and international roles with world-leading companies."
//     },
//     {
//       icon: <Star className="w-6 h-6" />,
//       title: "Skill Validation",
//       description: "Showcase your expertise with verified skills and recognized certifications."
//     },
//     {
//       icon: <TrendingUp className="w-6 h-6" />,
//       title: "Career Growth",
//       description: "Get tailored recommendations, upskill with our resources, and grow your career faster."
//     },
//     {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* <section className="relative py-32 lg:py-56 overflow-visible">
        <div className="max-w-7xl mx-auto text-center">
          <motion.h1
            className="text-4xl md:text-6xl font-cosmic font-bold mb-6 georgian-safe-line overflow-visible"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            style={{ 
          ...
          >
            <span 
              className="bg-gradient-nebula bg-clip-text text-transparent"
              style={{ 
                display: 'inline',
